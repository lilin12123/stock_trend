...
本项目是一个以**日内股票趋势观察**为核心的盘中监控工具，订阅 Futu OpenD 的盘中 `1m/5m` K 线，基于技术指标与规则引擎生成**日内趋势提示**，为日内交易提供辅助指引。当前版本支持 Telegram/本地通知、本地 Web 控制台、SQLite 持久化、全局股票池、用户自选池、规则覆盖和本地回测入口。
